...
def get_predictions(age, sex, cp, trestbps, chol, fbs, restecg, thalach, exang,
                    oldpeak, slope, ca, thal, req_model):
    mylist = [age, sex, cp, trestbps, chol, fbs, restecg,
...
def my_form_post():
    if request.method == 'POST':
        ...
        target = get_predictions(age, sex, cp, trestbps, chol, fbs,
